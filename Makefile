...
runtest : tracer.so mintest
	setarch x86_64 -R $(PINPATH)/pin -injection child -t tracer.so -o mintest.log -- ./mintest

rundeeploops : tracer.so deeploops
	setarch x86_64 -R $(PINPATH)/pin -injection child -t tracer.so -o deeploops.log -- ./deeploops
